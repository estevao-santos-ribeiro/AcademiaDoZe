...
public class ValueObjectsTests
{
    ...
    [Theory(DisplayName = "Endereco: valida obrigatoriamente do logradouro e número")]
    ...
    [InlineData(null)]
    [InlineData("")]
    public void Deve_Falhar_Criacao_Quando_SenhaNulaOuVazio(string? input)
    {
